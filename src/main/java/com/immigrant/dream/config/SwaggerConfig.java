...
public class SwaggerConfig {
    ...
    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Immigrant Dream API", "This service Immigrant dreams",
            "1.0", "Educational purpose", DEFAULT_CONTACT, "http://www.apache.org/licenses/LICENSE-2.0",
            "http://localhost:8000/swagger-ui.html", new HashSet<>());
